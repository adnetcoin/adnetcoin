...
#ifndef ADNETCOIN_TEST_SCRIPTNUM10_H
#define ADNETCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Adnetcoin Core 0.10.0, for cross-comparison.
 */
public:
