...
#ifndef ADNETCOIN_WALLET_WALLET_H
#define ADNETCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this adnetcoin node, and set to 0 for transactions that were created
...
#endif // ADNETCOIN_WALLET_WALLET_H
