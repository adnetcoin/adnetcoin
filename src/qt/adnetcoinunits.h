...
#ifndef ADNETCOIN_QT_ADNETCOINUNITS_H
#define ADNETCOIN_QT_ADNETCOINUNITS_H
...
/** Adnetcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class AdnetcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit AdnetcoinUnits(QObject *parent);

    /** Adnetcoin units.
     *  Adnetcoin units (Adnetcoin unit work the same as Bitoin).
     *  @note Source: https://en.adnetcoin.it/wiki/Units . 
...
typedef AdnetcoinUnits::Unit AdnetcoinUnit;

#endif // ADNETCOIN_QT_ADNETCOINUNITS_H
