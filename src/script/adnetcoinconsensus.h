...
#ifndef ADNETCOIN_ADNETCOINCONSENSUS_H
#define ADNETCOIN_ADNETCOINCONSENSUS_H

#include <stdint.h>

#if defined(BUILD_ADNETCOIN_INTERNAL) && defined(HAVE_CONFIG_H)
#include "config/adnetcoin-config.h"
  ...
  #endif
#elif defined(MSC_VER) && !defined(STATIC_LIBADNETCOINCONSENSUS)
...
#define ADNETCOINCONSENSUS_API_VER 1
...
#endif // ADNETCOIN_ADNETCOINCONSENSUS_H
