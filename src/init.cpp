 ...
 * between adnetcoind, and adnetcoin-qt and non-server tools.
*/
...
void Shutdown()
{
    ...
    RenameThread("adnetcoin-shutoff");
...
#ifndef WIN32
    strUsage += HelpMessageOpt("-pid=<file>", strprintf(_("Specify pid file (default: %s)"), ADNETCOIN_PID_FILENAME));
#endif
...
void ThreadImport(std::vector<fs::path> vImportFiles)
{
    ...
    RenameThread("adnetcoin-loadblk");
...
/** Sanity checks
 *  Ensure that Adnetcoin is running in a usable environment with all
...
static bool LockDataDirectory(bool probeOnly)
{
    ...
    // Make sure only a single Adnetcoin process is using the data directory.
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    LogPrintf("Using config file %s\n", GetConfigFile(gArgs.GetArg("-conf", ADNETCOIN_CONF_FILENAME)).string());
