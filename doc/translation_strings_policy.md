...
This document provides guidelines for internationalization of the Adnetcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `adnetcoin_en.ts` remains unchanged.
