Adnetcoin Core version 0.13.2 is now available from:

  <https://adnetcoin.cash/bin/adnetcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update adnetcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow adnetcoin-tx to create v2 transactions (adnetdrak)
