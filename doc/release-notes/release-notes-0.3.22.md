Download URL: https://sourceforge.net/projects/adnetcoin/files/Adnetcoin/adnetcoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 ADNET fee schedule (users still pay 0.01 ADNET per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #adnetcoin00 - #adnetcoin99
