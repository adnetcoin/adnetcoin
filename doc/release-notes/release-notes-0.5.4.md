Adnetcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/adnetcoin/files/Adnetcoin/adnetcoin-0.5.4/
...
http://gitorious.org/adnetcoin/adnetcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Adnetcoin-Qt notifications under Growl 1.3.
Increase required age of Adnetcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxAdnetcoin properly when installing Adnetcoin-Qt over it. (Windows)
