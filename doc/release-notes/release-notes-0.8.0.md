Adnetcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/adnetcoin/files/Adnetcoin/adnetcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Adnetcoin
...
New/changed settings (command-line or adnetcoin.conf file)
--------------------------------------------------------
