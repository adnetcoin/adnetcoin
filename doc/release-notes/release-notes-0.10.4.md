Adnetcoin Core version 0.10.4 is now available from:

  <https://adnetcoin.cash/bin/adnetcoin-core-0.10.4/>
...
- #6953 `43c2789` Split adnetcoin-tx into its own package
- #6953 `dfe0d4d` Include adnetcoin-tx binary on Debian/Ubuntu
