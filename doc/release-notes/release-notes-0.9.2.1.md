Adnetcoin Core version 0.9.2.1 is now available from:

  https://adnetcoin.cash/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 ADNET to 0.01 ADNET
...
- Fix "Start adnetcoin on system login"
