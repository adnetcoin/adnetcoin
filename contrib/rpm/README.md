...
[Bitcoin git repository](https://github.com/adnetcoin/adnetcoin) but are not part of
...
in the adnetcoin git repository. At present only an SVG version of the Bitcoin
icon is used.
