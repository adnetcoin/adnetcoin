...
unlocked to sign the Adnetcoin-Qt.app bundle.
...
allowing somebody to distribute a Adnetcoin-Qt.app or adnetcoin-qt-setup.exe with a valid
...
that the adnetcoin-qt.exe file inside the installer had not been tampered with.
